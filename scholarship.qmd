...
DSI offers merit-based scholarships to some of our admitted MSDS students. Scholarship awards are for one year (3 quarters) with the student enrolling full-time, assuming the student takes three or more courses for each quarter (Autumn, Winter, and Spring). Otherwise, the scholarship could be adjusted or revoked.  
