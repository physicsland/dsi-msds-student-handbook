...
- **Summer Quarter**: if you need to take summer course(s), for example with course-based CPT, student will need to **self term activate** for the summer. Follow the [self-term-activationinstructions](https://registrar.uchicago.edu/calendars/self-term-activation-instructions/) here. 
