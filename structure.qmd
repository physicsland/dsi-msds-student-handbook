...
- **Foundational Courses (3 courses)**: These cover essential concepts and practices in (1) programming, (2) mathematics, and (3) statistical knowledge that is central to data science and provide the groundwork for advanced coursework. Students can qualify for waivers or be exempted from these courses.  If needed to take these (online, free) courses, they should be completed in the summer before they begin with the MSDS program in the Autumn, or during the beginning of the Autumn quarter if the course is not offered in the summer.  
- **Core Courses (5 courses)**: These delve into key data science techniques, methodologies, and tools.
  ...
  * DATA 34100 Introduction to Data Systems and Data Design **OR** \
...
- Successfully complete all 9 required courses (core plus electives), with each course receiving a 'C' or better grade. 
- Cumulative University **GPA of 3.0** (all courses) for good academic standing.
- Cumulative **GPA of 3.3** for the **nine core plus elective courses**. 
...
- **Minimum Enrollment**: At least one course per quarter is required to maintain active enrollment, unless a formal leave of absence (LOA) is granted by the Dean of Students (DOS).
- **Summer Quarter**: if you need to take summer course(s), for example with course-based CPT, student will need to **self-term activate** for the summer. Follow the [self-term activation instructions](https://registrar.uchicago.edu/registration/college-process/self-term-activation/) here. 
