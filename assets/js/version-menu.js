    ...
    versionMenu.innerHTML = `
        <div class="dropdown">
            ...
            <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                <li><a class="dropdown-item" href="/dsi-msds-student-handbook/">2026 (Current)</a></li>
                <li><a class="dropdown-item" href="/dsi-msds-student-handbook/2025/">2025</a></li>
...
// --------------------------
// 2. Extract version from meta tag
// --------------------------
...
// --------------------------
// 3. Add Version text to right nav
// --------------------------
...
if (rightNav) {
    ...
    li.innerHTML = '<span class="nav-link">Selected: <span class="badge bg-success">' + version + '</span></span>';
    rightNav.prepend(li);
}
